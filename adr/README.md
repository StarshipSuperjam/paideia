...
**Phase 1.5 (Mission Realignment Overhaul) opens at S-0013** with ADR 0033 (mission realignment: structured guidance for self-learners; records obsolescence of the globe / mastery-glow / cross-domain-tendrils / trophy / "knowledge as a world" UI metaphor as deliberate architectural removal; light-revises ADR 0018 to remove the globe-rendering use case while preserving the algorithm). Phase 1.5 continues across S-0014 (ADR 0034 Discovery / Planning / Engagement triad as primary product structure; substantial rewrites of `docs/ui-architecture.md` and `docs/session-lifecycle.md`), S-0015 (ADR 0035 multi-platform Apple expansion superseding [ADR 0032](0032-personal-project-disposition.md) by broadening commitment 1 to iPhone + iPad + Mac via Designed-for-iPad; Phase 9 success criteria rewritten), and S-0016 (rendering policy [ADR 0027](0027-rendering-policy-prompt-layer-contract.md) extended with forbidden tokens for globe / reward / territory / exploration language; light revisions to [ADR 0012](0012-freshman-defaults-autodidact-ceiling.md) and [ADR 0014](0014-sonnet-teaches-opus-reviews.md); secondary docs sweep). Phase 2 (Build Plan Scaffolding) opens at S-0017 with the realigned contract as input.
