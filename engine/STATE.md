...
**S-0136 verification still pending**: T1-A — first GitHub Actions run on `main` post-S-0136 (the deliverable push). Expected: `Run pytest engine/tools with coverage` step exits 0; coverage summary visible in step summary at TOTAL 80%. Captured in `pytest_cov_first_exercise.md`'s Status section.
