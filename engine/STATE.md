...
- **Cross-reference sweep across the migrated tree.** Every `[link](relative/path.md)` in moved files needs verification; rewrite where the relative-path geometry changed. Particular attention to:
