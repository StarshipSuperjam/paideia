...
| [`adversarial_stance_first_exercise.md`](adversarial_stance_first_exercise.md) | S-0085 (per [ADR 0057](../adr/0057-adversarial-stance-for-health-check-audits.md)) | First exercise landed at S-0097 cadence-fired audit ([docs/health-checks/S-0097.md](../../docs/health-checks/S-0097.md)); T1-A through T1-E all closed | Closed |
