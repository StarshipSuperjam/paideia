...
- [ADR 0084](0084-pushback-rule-extraction-step-for-high-stakes-decisions.md) — applies the doubt-driven extraction step retrospectively as historical workflow application #3; identifies the "structural-phase functions are categorically in-memory file/regex" assumption as the load-bearing unverified premise whose falsification at S-0127 motivated the S-0127 in-session re-fold. Per ADR 0036 the ADR text is not retroactively migrated.
