...
These are candidates, not commitments. The goal is net-zero operating costs before opening to general use.
...
**Freemium model.** Mastery map browsing and syllabus generation are cheap API calls — keep those free. Deep close-reading sessions (multi-turn, token-heavy) sit behind a paywall. $8-12/month discussed as a price point, cheaper than a single philosophy course and positioned against Coursera/Great Courses.
...
---
*Last updated: 2026-04-08 (audience vs. market distinction resolved — community college students as primary audience shaping defaults, departments as deferred market; syllabus upload pipeline architecture reference added)*
