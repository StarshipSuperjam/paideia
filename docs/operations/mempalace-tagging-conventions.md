...
Apply when:
- A build session produces a CHANGELOG-tracked material change.
...
- Don't use `work` for the conclusion of a build session — the CHANGELOG already records that. Use `work` for the *journey* (obstacles, deferrals, surprises).
