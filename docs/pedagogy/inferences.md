...
- **Mastery-glow visualization computation** — mapping mastery state + cross-domain bridges to the globe rendering. Specification: Phase 9. Per [`docs/ui-architecture.md`](../ui-architecture.md).
