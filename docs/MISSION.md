...
2. **Commercial sustainability without pedagogical compromise.** Revenue logic must never change what the product teaches or how it teaches. ([ADR 0002](../adr/0002-commercial-sustainability-without-pedagogical-compromise.md); operating discipline that supports this commitment: [ADR 0029](../adr/0029-personal-financial-cost-ceiling.md) — personal financial cost ceiling)
