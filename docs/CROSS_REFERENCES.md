...
- [`adr/0027-rendering-policy-prompt-layer-contract.md`](../adr/0027-rendering-policy-prompt-layer-contract.md) rendering policy → [`AGENT_INSTRUCTIONS.md`](../AGENT_INSTRUCTIONS.md) (the contract artifact that ships as Sonnet's system prompt), [`docs/pedagogy.md`](pedagogy.md) (Layered Instruction Architecture row), [`ROADMAP.md`](../ROADMAP.md) (Phase 7 success criterion: zero forbidden-token leakage; Phase 4 `tools/validate.py` rendering-audit category). Operationalizes [ADR 0026](../adr/0026-persistent-learner-storage-structural-not-substantive.md)'s `pattern_observed` writing constraint at the agent's write time.
- [`adr/0028-input-side-scope-structural-not-prompt.md`](../adr/0028-input-side-scope-structural-not-prompt.md) input-side scope → [`AGENT_INSTRUCTIONS.md`](../AGENT_INSTRUCTIONS.md) (Scope discipline section), [`docs/pedagogy.md`](pedagogy.md) (Layered Instruction Architecture row: Interaction-surface scope), [`docs/ui-architecture.md`](ui-architecture.md) (Phase 9 exit-affordance UI primitive specification target), [`ROADMAP.md`](../ROADMAP.md) (Phase 9 success criteria — exit affordance + no general chat surface). Sibling to [ADR 0027](../adr/0027-rendering-policy-prompt-layer-contract.md) — the input-output bidirectional contract for the teaching surface.
- [`adr/0029-personal-financial-cost-ceiling.md`](../adr/0029-personal-financial-cost-ceiling.md) cost ceiling → [`docs/business.md`](business.md) (Personal Financial Risk Ceiling section + Revenue Mechanisms reframing), [`docs/MISSION.md`](MISSION.md) commitment 2 (operating-discipline cross-link), [`docs/tensions.md`](tensions.md) (OQ-BYOK-REGIME, OQ-WALL-BEHAVIOR, OQ-CONTEXT-COMPRESSION — three deferred sub-decisions), [`ROADMAP.md`](../ROADMAP.md) (Phase 7 OQ-CONTEXT-COMPRESSION decide-before; Phase 8 cost-cap precondition; Phase 9 cost-cap operates against production surface). Five consumers of the cost-protection-as-precondition principle.
- [`adr/0030-confidence-level-evidentiary-mode-on-nodes.md`](../adr/0030-confidence-level-evidentiary-mode-on-nodes.md) `confidence_level` evidentiary-mode column → [`docs/architecture.md`](architecture.md) (Node Schema column + per-value semantics), [`docs/self-correction.md`](self-correction.md) (Synthetic-Node Review Queue), [`adr/0016-graph-construction-needs-live-validation.md`](../adr/0016-graph-construction-needs-live-validation.md) (Phase 4 audit soft-warn category for SYNTHETIC nodes), [`adr/0021-node-deprecation-status-superseded-by.md`](../adr/0021-node-deprecation-status-superseded-by.md) (supersession is the channel for evidentiary-mode change — labels do not update in place), [`ROADMAP.md`](../ROADMAP.md) (Phase 3 column in migration; Phase 4 audit consumer; Phase 5.2 INTERPRETED baseline + Phase 5.3 explicit per-INSERT requirement). Five consumers of the categorical-evidentiary-mode-vs-numeric-belief distinction.
- [`adr/0031-erasure-mechanism-and-individual-only-regime.md`](../adr/0031-erasure-mechanism-and-individual-only-regime.md) erasure mechanism + individual-only regime → [`docs/learner-model.md`](learner-model.md) (`learner_events` cascade-deletion at Phase 3), [`docs/self-correction.md`](self-correction.md) (`tension_log` cascade-deletion via the user link), [`adr/0026-persistent-learner-storage-structural-not-substantive.md`](../adr/0026-persistent-learner-storage-structural-not-substantive.md) (sub-decision (2) amended — `cohort_id` removed from the `learner_events.context` column set), [`docs/business.md`](business.md) (Account Ownership and Transfer Path, Internal fine-tuning cascade-implication), [`ROADMAP.md`](../ROADMAP.md) (Phase 3 schema cascade discipline; Phase 8 App Store guideline 5.1.1 satisfied at the schema level; Phase 9 delete-account UI affordance). Five consumers of the cascade-deletion + no-institutional-regime simplification.
...
- **Phase 6 → Phase 7** — `OQ-CONTEXT-COMPRESSION` (per [`docs/tensions.md`](tensions.md)) settled with an Accepted ADR before Phase 7 prototype runs sustained multi-turn engagements.
- **Phase 7 → Phase 8** — `OQ-WALL-BEHAVIOR` (per [`docs/tensions.md`](tensions.md)) settled with an Accepted ADR; cost-cap mechanism per [ADR 0029](../adr/0029-personal-financial-cost-ceiling.md) wired and tested before evaluation users are admitted in Phase 8.
- **Phase 8 → Phase 9** — `OQ-BYOK-REGIME` (per [`docs/tensions.md`](tensions.md)) settled with an Accepted ADR before any non-builder consumer launch surface ships. Exit affordance UI primitive per [ADR 0028](../adr/0028-input-side-scope-structural-not-prompt.md) implemented in the Phase 9 UI prototype.
