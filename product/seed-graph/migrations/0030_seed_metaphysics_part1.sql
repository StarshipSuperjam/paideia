...
--   SELECT count(*)::int FROM public.nodes WHERE graph_version_added = 4 AND 'metaphysics' = ANY(domain) :: 27
--   SELECT count(*)::int FROM public.edges WHERE graph_version_added = 4 AND edge_type = 'pedagogical_prerequisite' :: 30
--   SELECT graph_version FROM public.settings WHERE id = 1 :: 4
-- Invariants:
