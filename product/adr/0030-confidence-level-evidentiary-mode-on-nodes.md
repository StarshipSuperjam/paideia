...
- **Phase 4 audit category lands without code change.** [ADR 0016](../../engine/adr/0016-graph-construction-needs-live-validation.md) already names the SYNTHETIC soft-warn; the Phase 4 implementation against the live DB now has a concrete column to query. No revision to ADR 0016 is required.
...
- [ADR 0016](../../engine/adr/0016-graph-construction-needs-live-validation.md) — Phase 4 graph-audit soft-warn category for SYNTHETIC nodes.
